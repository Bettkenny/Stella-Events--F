      ...
      <div className="about-section-text-container">
        ...
        <div className="primary-text">
          <p>
            ...
            booking process, providing users with a user-friendly interface and
            seamless booking experience. Our integrated ticket booking
        ...
        <div className="primary-text">
          ...
          <div className="key-features-item">
            ...
            <p>
              ...
              including descriptions, host, and venue details, etc. Users can buy
              tickets for events directly from the event pages.
            </p>
          </div>
          <div className="key-features-item">
          ...
          <div className="key-features-item">
            ...
            <p>
              Event listings are no longer static lists; they come alive with
              interactive elements like hover details, event previews, and
